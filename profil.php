...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand logona judl" href="#"><b><i>Galleri'a</i></b></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="btn dropdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                        <a href="editprofil.php"><img src="gambar/aku.jpg" alt="profil" class="profil-img"></a>
</div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid profile">
        <div class="row profile-info">
            <div class="col-4 text-center">
                ...
                <div class="image-container" style="text-align: center;">
                    <img src="gambar/aku.jpg" alt="Profile"  class="profil-img1">
                </div>
            </div>
            <div class="col-8">
                <!-- Text container -->
                <div class="text-container">
                    <h2 class="judul"><i><b>Galleri'a</b></i></h2>
                    <p class="nama-lengkap">Nevira Aulia Br Sembiring</p>
        ...
        <div class="row profile-posts">
            <div class="col-4 gambar">
                <img src="gambar/gunung2.jpg" alt="Post 1">
            </div>
            <div class="col-4 gambar">
                <img src="gambar/gunung2.jpg" alt="Post 2">
            </div>
            <div class="col-4 gambar">
                <img src="gambar/gunung2.jpg" alt="Post 3">
            </div>
            <div class="col-4 gambar">
                <img src="gambar/gunung2.jpg" alt="Post 3">
            </div>
    ...
    <div class="mt-5 .footer">
        <footer class="text-center text-lg-start" style="background-color: #DC3535;">
            <div class="text-center text-gray p-3" style="background-color: #CAE8EF;">
                Copyright©:
                <a class="text-gray" href="">UKK RPL-3 2024 | NeviraAulia</a>
            </div>
        </footer>
    </div>
